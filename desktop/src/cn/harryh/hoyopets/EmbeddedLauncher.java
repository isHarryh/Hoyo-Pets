...
/** The bootstrap for HoyoPets the libGDX app.
 * @see HoyoPets
 */
public class EmbeddedLauncher {
    ...
    public static void main(String[] args) {
        ...
        HoyoConfig appConfig = Objects.requireNonNull(HoyoConfig.getConfig());
        try {
        ...
        try {
            ...
            // Instantiate the App
            Lwjgl3Application app = new Lwjgl3Application(new HoyoPets(TITLE), config);
        } catch (Exception e) {
            WindowSystem.free();
