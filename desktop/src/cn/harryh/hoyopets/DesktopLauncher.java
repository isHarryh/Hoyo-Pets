...
import static cn.harryh.hoyopets.Const.LogConfig;
import static cn.harryh.hoyopets.Const.appVersion;
...
public class DesktopLauncher {
    public static void main(String[] args) {
        ...
        try {
            Logger.setLevel(Objects.requireNonNull(HoyoConfig.getConfig()).logging_level);
        ...
        Logger.info("System", "HoyoPets version is " + appVersion);
        ...
        // Java FX bootstrap
        Application.launch(HoyoHomeFX.class, args);
