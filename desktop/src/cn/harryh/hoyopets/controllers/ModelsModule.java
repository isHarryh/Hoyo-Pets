...
import cn.harryh.hoyopets.assets.ModelItem;
import cn.harryh.hoyopets.assets.ModelItemGroup;
import cn.harryh.hoyopets.assets.ModelsDataset;
import cn.harryh.arkpets.utils.*;
import cn.harryh.arkpets.utils.GuiPrefabs;
import cn.harryh.arkpets.utils.NetUtils;
import cn.harryh.hoyopets.guitasks.*;
...
import static cn.harryh.hoyopets.Const.PathConfig.*;


public final class ModelsModule implements Controller<HoyoHomeFX> {
    @FXML
...
//        selectedModelSkinGroupName.setText(model.skinGroupName);
        selectedModelType.setText(model.type);
