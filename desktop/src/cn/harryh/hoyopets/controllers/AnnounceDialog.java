...
import cn.harryh.hoyopets.guitasks.FetchAnnounceTask;
import cn.harryh.hoyopets.guitasks.GuiTask.GuiTaskStyle;
...
import static cn.harryh.hoyopets.Const.durationFast;


public final class AnnounceDialog implements Controller<HoyoHomeFX> {
    @FXML
    ...
    private static class AnnounceReadHandler {
        ...
        public AnnounceReadHandler(HoyoConfig config) {
            this.config = config;
