 ...
 * At GPL-3.0 License
 */
package cn.harryh.hoyopets.tray;

import cn.harryh.hoyopets.HoyoPets;
import cn.harryh.hoyopets.animations.AnimData;
import cn.harryh.hoyopets.concurrent.SocketClient;
import cn.harryh.hoyopets.concurrent.SocketData;
import cn.harryh.hoyopets.concurrent.SocketSession;
...
import static cn.harryh.hoyopets.Const.durationNormal;
import static cn.harryh.hoyopets.Const.iconFilePng;


public class MemberTrayImpl extends MemberTray {
    private final HoyoPets hoyoPets;
    ...
    /**
     * Initializes a per-character tray icon instance for an HoyoPets. <br/>
     * Must be used after Gdx.app was initialized.
     *
     * @param boundHoyoPets The HoyoPets instance that bound to the tray icon.
     * @param client        The socket client that bound to the tray icon.
     */
    public MemberTrayImpl(HoyoPets boundHoyoPets, SocketClient client) {
        super(getName(boundHoyoPets));
        hoyoPets = boundHoyoPets;
        this.client = client;
    ...
    private static String getName(HoyoPets boundHoyoPets) {
        return (boundHoyoPets.config.character_label == null || boundHoyoPets.config.character_label.isEmpty()) ?
                "Unknown" : boundHoyoPets.config.character_label;
    }
    ...
    public void onTransparentDis() {
        ...
        hoyoPets.setTransparentMode(false);
    ...
    public void onTransparentEn() {
        ...
        hoyoPets.setTransparentMode(true);
    ...
    public void onKeepAnimEn() {
        ...
        keepAnim = hoyoPets.cha.getPlaying();
