...
public class MemberTrayProxy extends MemberTray {
    ...
    /** Initializes a host-proxy tray icon instance for a registering HoyoPets.
     * @param socketData The HoyoPets login data.
     * @param session The session to communicate with that HoyoPets.
